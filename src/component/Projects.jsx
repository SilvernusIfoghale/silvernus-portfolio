      ...
      <div className="my-10">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-7 ">
          ...
          <div>
            ...
            <p>
              <a href="#" className="text-blue-100 font-bold underline text-sm">
                Live Demo
              </a>
            </p>
            <p>
          ...
          <div>
            <p className="text-gray-300 font-semibold text-5xl py-2">07</p>
            ...
            <p>
              <a href="#" className="text-blue-100 underline font-bold text-sm">
                Live Demo
              </a>
            </p>
            <p>
